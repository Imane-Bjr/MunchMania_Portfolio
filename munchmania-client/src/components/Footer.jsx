    ...
    return (
      <div>
        <footer className= 'footer xl:px-24 py-10 px-4 text-base-content'>
          <aside>
            <img src={logo} alt="" className='-mt-8 pb-6 h-26 w-auto' />
            <p className="-mt-8 md:w-40">
              Savor the artistry of a culinary masterpiece
            </p>
          </aside>
          <nav>
          ...
          <nav>
            ...
            <a className="link link-hover">+212 780 120 103</a>
